...
export default function OpsLoginPage() {
  ...
  async function handleForgotPassword(e: React.FormEvent) {
    ...
    try {
      const res = await fetch("/api/ops/forgot-password", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  async function handleResetPassword(e: React.FormEvent) {
    ...
    try {
      const res = await fetch("/api/ops/reset-password", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const btnPrimaryClass =
    "w-full bg-[var(--anna-sage-dark)] hover:bg-[var(--anna-sage)] text-white rounded-xl h-10 text-sm font-semibold transition-colors";
              ...
              <div className="mt-5 p-3 rounded-xl bg-[var(--anna-bg)] border border-[var(--anna-border)]">
                ...
                <div className="space-y-1">
                  <div className="flex items-center justify-between text-xs">
                    <span className="text-[var(--anna-slate-light)]">ADMIN</span>
            ...
            <>
              <div className="mb-5">
                ...
                <p className="text-xs text-[var(--anna-muted)] mt-1">
                  Enter the email associated with your ops account.
                </p>
              </div>
