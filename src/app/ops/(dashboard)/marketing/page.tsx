...
import type {
  ...
  CampaignStatus,
} from "@/components/ops/marketing/types";

// ============================================================
// Anna.I — Ops Marketing Page
// ============================================================
// Lists every campaign with desktop table + mobile cards,
// opens a detail slide-in on row click, and supports creating
// new campaigns. Filtering by status + free-text search is done
// client-side on top of the /api/ops/campaigns list response.
// ============================================================
...
export default function MarketingPage() {
  ...
  const pillOptions = STATUS_PILL_OPTIONS.map((opt) => ({
    ...opt,
        ...
        <OpsEmptyState
          ...
          subtitle={
            search || statusFilter !== "ALL"
              ...
              : canCreate
                ? "Create your first campaign to start issuing discount codes"
