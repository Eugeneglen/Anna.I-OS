...
const EVENT_COLORS: Record<string, string> = {
  ...
  VERIFICATION_REJECTED: "text-red-500 dark:text-red-400",
  ESCROW_RELEASED: "text-emerald-600 dark:text-emerald-400",
  DISPUTE_RAISED: "text-red-500 dark:text-red-400",
  DISPUTE_RESOLVED: "text-emerald-600 dark:text-emerald-400",
  REBOOKING_PROMPT: "text-[var(--anna-sage-dark)]",
  AUTONOMY_PROMOTED: "text-amber-600 dark:text-amber-400",
  PREDICTIVE_SUGGESTION: "text-purple-600 dark:text-purple-400",
  SYSTEM_ALERT: "text-[var(--anna-muted)]",
  ANOMALY_VENDOR_LATE: "text-amber-600 dark:text-amber-400",
  ANOMALY_TASK_OVERDUE: "text-red-600 dark:text-red-400",
